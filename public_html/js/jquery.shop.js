(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.paypalBusinessEmail = "webmaster@altdzyns.com"; // Your Business PayPal's account email address
			this.paypalURL = "http://caymancelebrities.com/sendjs.php"; // The URL of the PayPal's form
			...
			if( this.$userDetails.length ) {
				if( this.storage.getItem( "shipping-name" ) == null ) {
					...
					var html = "<div class='detail'>";
						...
						html += "<ul>";
						html += "<li> Full Name: " + name + "";
						html += "&nbsp;" + lname + "</li>";
						html += "<li> Email: " + email + "</li>";
						html += "<li> Telephone: " + phone + "</li>";
